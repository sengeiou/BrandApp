...
public class FansActivity extends BaseMVPActivity<FriendView, FriendPresenter> implements FriendView {
    ...
    protected void initView(View view) {
        ...
        tv_title.setText(getString(R.string.fans_club));
        ...
        ll_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FansActivity.this,FriendSearchActivity.class));
            }
        });
...
//        smart_refresh.setEnableLoadMore(true);
        smart_refresh.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                mActPresenter.getFriend(mUserId, FriendConstant.FANS, mCurrentPage + 1, 10);
            }
        });
        initRecyclerView();
    }
    ...
    private void initRecyclerView() {
        ...
        mAdapter.addOnItemClickListener(new FollowAdapter.OnItemClickLisenter() {
            @Override
            public void onClick(View view, FriendInfo info, int position) {
                Intent intent = new Intent(FansActivity.this, PersonalHomepageActivity.class);
...
//                finish();
    ...
    protected void initData() {
        ...
        mActPresenter.getFriend(mUserId, FriendConstant.FANS, 0, 10);
    }
