...
public class FollowActivity extends BaseMVPActivity<FriendView, FriendPresenter> implements FriendView {
    ...
    protected void initView(View view) {
        ...
        tv_title.setText(getString(R.string.friend_follow));
        ...
        ll_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FollowActivity.this,FriendSearchActivity.class));
            }
        });
...
//        smart_refresh.setEnableLoadMore(true);
        smart_refresh.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                mActPresenter.getFriend(mUserId, FriendConstant.MY_FOLLOW, mCurrentPage + 1, 10);
            }
        });
        initRecyclerView();
    }
    ...
    private void initRecyclerView() {
        ...
        mAdapter.addOnItemClickListener(new FollowAdapter.OnItemClickLisenter() {
            @Override
            public void onClick(View view, FriendInfo info, int position) {
                Intent intent=new Intent(FollowActivity.this, PersonalHomepageActivity.class);
...
//               finish();
    ...
    protected void onResume() {
        super.onResume();
        mCurrentPage=0;
        mActPresenter.getFriend(mUserId, FriendConstant.MY_FOLLOW, 0, 10);
    }
