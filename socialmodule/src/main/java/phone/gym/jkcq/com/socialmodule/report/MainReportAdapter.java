...
public class MainReportAdapter extends BaseQuickAdapter<ReportBean, BaseViewHolder> {

    private OnChildClickLisenter mOnChildClickLisenter;
    private OnChildLongClickLisenter mOnChildLongClickLisenter;
    private OnItemClickLisenter mOnItemClickLisenter;

    public MainReportAdapter(List<ReportBean> data) {
        super(R.layout.friend_item_main_report, data);
    }
    ...
    protected void convert(BaseViewHolder holder, ReportBean info) {
        ...
        if (info.getReplyNums() > 0) {
            holder.setGone(R.id.tv_repeat_number, false);
            holder.setText(R.id.tv_repeat_number, String.format(UIUtils.getString(R.string.comment_reply_number), info.getReplyNums() + ""));
        } else {
            holder.setGone(R.id.tv_repeat_number, false);
            holder.setText(R.id.tv_repeat_number, String.format(UIUtils.getString(R.string.comment_reply_number), "0"));
        }
