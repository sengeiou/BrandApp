...
/** 
 * DAO for table "OXYGEN_MODE".
*/
public class OxygenModeDao extends AbstractDao<OxygenMode, Long> {

    public static final String TABLENAME = "OXYGEN_MODE";

    /**
     * Properties of entity OxygenMode.<br/>
    ...
    */
    ...
    public OxygenModeDao(DaoConfig config) {
        super(config);
    }
    
    public OxygenModeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"OXYGEN_MODE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"OXYGEN_MODE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, OxygenMode entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, OxygenMode entity) {
        stmt.clearBindings();
    ...
    @Override
    public OxygenMode readEntity(Cursor cursor, int offset) {
        OxygenMode entity = new OxygenMode( //
    ...
    @Override
    public void readEntity(Cursor cursor, OxygenMode entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(OxygenMode entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(OxygenMode entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
