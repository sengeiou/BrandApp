...
public class W526Device extends BaseDevice implements IDeviceType, IWatch516, IWatchW526, IBraceletW520 {
    ...
    public W526Device(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_WATCH_W526;
    }
    ...
    public void set_general(boolean open24HeartRate, boolean isHeart) {
        ...
        // WatchW526BleManager.getInstance().set_general(open24HeartRate, isHeart);
