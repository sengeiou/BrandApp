...
public class W557Device extends BaseDevice implements IDeviceType, IWatch516, IWatchW526, IBraceletW520, IWatchW557 {
    ...
    public W557Device(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_WATCH_W557;
    }
    ...
    public void setTempSub(int value) {
        WatchW557BleManager.getInstance().setTempSub(value);
    }

    @Override
    public void getTempSub() {
        WatchW557BleManager.getInstance().getTempSub();
    }
