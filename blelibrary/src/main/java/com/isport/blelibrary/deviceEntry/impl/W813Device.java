 ...
 * @描述
 */
public class W813Device extends BaseDevice implements IDeviceType, IBraceletW311, ITarget, IBraceletW520 {

    public W813Device(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_BRAND_W813;
    }
