...
import com.isport.blelibrary.deviceEntry.interfaces.IS002;
...
public class S002BDevice extends BaseDevice implements IDeviceType, IWatch516, IWatchW526, IBraceletW520, IWatchW557, IS002 {
    ...
    public S002BDevice(String name, String mac) {
        super();
    ...
    public void get_daily_record(int day) {
        ...
        WatchW557BleManager.getInstance().syncRopeData();
    }
    ...
    public void getRopeState() {
        WatchW557BleManager.getInstance().getRopeState();
    }

    @Override
    public void startOrEndRopeSport(int Open) {
        WatchW557BleManager.getInstance().startOrEndRope(Open);
    }

    @Override
    public void setRopeType(int type, int min, int sec, int number, int pk) {
        WatchW557BleManager.getInstance().setRopeState(type, min, sec, number, pk);
    }

    @Override
    public void setRopeType(int type) {
        WatchW557BleManager.getInstance().setRopeState(type);
    }

    @Override
    public void setMaxHrRemid(int maxhr) {
        WatchW557BleManager.getInstance().setMaxHrRemid(maxhr);
    }
}
