 ...
 * @描述
 */
public class W814Device extends BaseDevice implements IDeviceType, IBraceletW311, ITarget, IBraceletW520 {

    public W814Device(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_BRAND_W814;
    }
    ...
    public void queryWatchFace() {
       // BraceletW311BleManager.getInstance().queryWatchFace();
    }
