 ...
 * @描述
 */
public class W817Device extends BaseDevice implements IDeviceType, IBraceletW311, IBraceletW520, ITarget {

    public W817Device(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_BRAND_W817;
    }
    ...
    public void set_hr_setting(boolean isOpen) {
        if (isOpen) {
            BraceletW811W814Manager.getInstance().openTimingMeasureHeartRate(1);
        } else {
            BraceletW811W814Manager.getInstance().closeTimingMeasureHeartRate();
        }
    }
