...
public class W812BDevice extends BaseDevice implements IDeviceType, IWatch516, IWatchW526, IBraceletW520, IWatchW557 {
    ...
    public W812BDevice(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_WATCH_W812B;
    }
