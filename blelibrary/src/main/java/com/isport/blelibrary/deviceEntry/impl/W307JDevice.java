 ...
 * @描述
 */
public class W307JDevice extends BaseDevice implements IDeviceType, IBraceletW311, IBraceletW520 {

    public W307JDevice(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_BRAND_W307J;
    }
    ...
    public void setSleepData(AutoSleep sleepData) {
        BraceletW520BleManager.getInstance().sendSleepData(sleepData);
    }

    @Override
    public void getSleepData() {
        BraceletW520BleManager.getInstance().getSleepData();
    }
