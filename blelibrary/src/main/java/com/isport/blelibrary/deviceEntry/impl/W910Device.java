 ...
 * @描述
 */
public class W910Device extends BaseDevice implements IDeviceType, IBraceletW311, ITarget, IBraceletW520 {

    public W910Device(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_BRAND_W910;
    }
