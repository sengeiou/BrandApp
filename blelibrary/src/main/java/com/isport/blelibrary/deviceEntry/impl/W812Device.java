 ...
 * @描述
 */
public class W812Device extends BaseDevice implements IDeviceType, IBraceletW311, IBraceletW520, ITarget {

    public W812Device(String name, String mac) {
        super();
    ...
    @Override
    public void setType() {
        this.deviceType = TYPE_BRAND_W812;
    }
