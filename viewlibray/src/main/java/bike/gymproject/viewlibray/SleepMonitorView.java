...
public class SleepMonitorView extends LinearLayout {
    ...
    public SleepMonitorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SleepMonitorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public SleepMonitorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initBase(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        drawableIcon = a.getDrawable(R.styleable.SleepItem_leftIcon);
    ...
    private void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_sleep_monitor_item, this, true);
        ...
        ivIcon.setBackground(drawableIcon);
