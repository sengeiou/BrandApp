 ...
 * Create at 2019/2/27
 */
public class WatchStepChartView extends View {
    ...
    public WatchStepChartView(Context context) {
        this(context, null);
    }

    public WatchStepChartView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WatchStepChartView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initBase(Context context, AttributeSet attrs, int defStyleAttr) {
        //获取我们自定义的样式属性
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.WatchStepChartView, defStyleAttr, 0);
        leftColor = array.getColor(R.styleable.WatchStepChartView_leftColor, Color.BLACK);
        selectLeftColor = array.getColor(R.styleable.WatchStepChartView_selectLeftColor, Color.BLACK);
        rightColor = array.getColor(R.styleable.WatchStepChartView_rightColor, Color.BLACK);
        selectRightColor = array.getColor(R.styleable.WatchStepChartView_selectRightColor, Color.BLACK);
        lineColor = array.getColor(R.styleable.WatchStepChartView_xyColor, Color.BLACK);
        lefrColorBottom = array.getColor(R.styleable.WatchStepChartView_leftColorBottom, Color.BLACK);
        rightColorBottom = array.getColor(R.styleable.WatchStepChartView_rightColorBottom, Color.BLACK);
        array.recycle();
        init();
    }
