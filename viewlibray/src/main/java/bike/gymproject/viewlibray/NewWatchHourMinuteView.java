...
public class NewWatchHourMinuteView extends LinearLayout {
    ...
    public NewWatchHourMinuteView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewWatchHourMinuteView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public NewWatchHourMinuteView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_watch_hour_min_item_new, this, true);
