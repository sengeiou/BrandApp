...
public class RopeTopTextview extends View {
    private static final String TAG = RopeTopTextview.class.getSimpleName();
    ...
    public RopeTopTextview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RopeTopTextview(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        initHintPaint(context);
    ...
    private void initLinePaint(Context context) {
        ...
        linePaint.setColor(context.getResources().getColor(R.color.common_item_bar_line_color));//#F3546A
