 ...
 * 线形图表
 */
public class LineScroChartView extends View {
    private static final String TAG = LineScroChartView.class.getSimpleName();
...
//    private int hintColor = Color.RED;
    ...
    public LineScroChartView(Context context) {
        super(context);
        init(context);
    }

    public LineScroChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LineScroChartView(Context context, AttributeSet attrs, int defStyleAttr) {
