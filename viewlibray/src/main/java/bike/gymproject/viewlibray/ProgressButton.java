...
public class ProgressButton extends AppCompatButton {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        int defaultButtonColor = getResources().getColor(R.color.common_item_line_color);
        //Get default progress color
        int defaultProgressColor = getResources().getColor(R.color.common_item_line_color);
        //Get default progress background color
        int defaultBackColor = getResources().getColor(R.color.common_item_line_color);
