...
public class LineChartPractiseView extends View {
    private static final String TAG = LineChartPractiseView.class.getSimpleName();
...
//    private int hintColor = Color.RED;
    ...
    public LineChartPractiseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LineChartPractiseView(Context context, AttributeSet attrs, int defStyleAttr) {
