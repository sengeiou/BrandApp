 ...
 * 线形图表
 */
public class LineRecRopeHrView extends View {
    private static final String TAG = LineRecRopeHrView.class.getSimpleName();
    ...
    public LineRecRopeHrView(Context context) {
        super(context);
        init(context);
    }

    public LineRecRopeHrView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LineRecRopeHrView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        initHintPaint(context);
    ...
    private void initMagin(Context context) {
        bottomMargin = DisplayUtils.dip2px(getContext(), 0);
        topMargin = DisplayUtils.dip2px(context, 10);
