 ...
 */
public abstract class BaseMVPWhiteTitleActivity<V extends BaseView, P extends BasePresenter<V>>
        extends BaseTitleWhiteActivity implements BaseView {
    ...
    public void onRespondError(String message) {
        netError(BaseMVPWhiteTitleActivity.this);
