...
public class DownloadFileUtils {
    ...
    private static class SingletonHolder {
        private final static DownloadFileUtils instance = new DownloadFileUtils();
    }
    ...
    public void downBin(String url, String path, String fileName, final onDownloadFileListener listener) {
