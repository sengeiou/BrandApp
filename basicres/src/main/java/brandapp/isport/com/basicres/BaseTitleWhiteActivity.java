...
public abstract class BaseTitleWhiteActivity extends BaseActivity {
    ...
    public View setBodyView() {
        View frameView = LayoutInflater.from(this).inflate(R.layout.common_activity_white_layout, null);
