 ...
 */
public class CommuniteDeviceAddDialog extends BaseDialog {
    TextView tvOk;
    Context mContext;


    public CommuniteDeviceAddDialog(Context context, int animation) {
        super(context, R.style.theme_customer_progress_dialog);
        this.setContentView(R.layout.dialog_device_guide);
