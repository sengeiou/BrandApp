package com.isport.brandapp.shadow;
...
public class ShadAllowLayout extends FrameLayout {  //上传不了？
    ...
    public ShadAllowLayout(Context context) {
        this(context, null);
    }

    public ShadAllowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public ShadAllowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        if (firstView == null) {
            firstView = ShadAllowLayout.this;
