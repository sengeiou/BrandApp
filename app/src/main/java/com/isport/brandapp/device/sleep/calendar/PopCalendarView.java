...
//        }
        ...
        if (monthDataListen != null) {
            String strMonth = mRightNow.get(Calendar.YEAR) + CommonDateUtil.formatTwoStr(mRightNow.get(Calendar.MONTH));
    ...
    public void goCurrentMonth() {
        ...
        requestLayout();
        if (monthDataListen != null) {
            String strMonth = mHelper.getYear() + CommonDateUtil.formatTwoStr(mHelper.getMonth());
            monthDataListen.getMontData(strMonth);
        }
