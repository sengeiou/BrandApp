 ...
 * 闹钟设置
 */
public class ActivityBraceletAlarmSetting extends BaseMVPTitleActivity<WatchView, WatchPresenter> implements WatchView, AlarmView, View.OnClickListener, ItemView.OnItemViewCheckedChangeListener {
    private final static String TAG = ActivityBraceletAlarmSetting.class.getSimpleName();
