    ...
    public static void show(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notification = new Notification.Builder(context, CHANNEL_ID)
                    .setContentTitle(context.getResources().getString(R.string.app_sleep_time_remind_title))
                    .setContentText(context.getResources().getString(R.string.app_sleep_time_remind_tips))
                    .setWhen(System.currentTimeMillis())
                    .setSmallIcon(R.drawable.ic_t_launcher)
                    .setColor(Color.parseColor("#FEDA26"))
                    .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_t_launcher))
                    // .setTicker("巴士门")
                    .build();
        } else {
