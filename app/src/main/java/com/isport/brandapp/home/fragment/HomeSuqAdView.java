...
public class HomeSuqAdView extends ViewGroup {
    ...
    private void init() {
        mBottom = DisplayUtils.dip2px(getContext(), 70);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
         ...
         * 只考虑一个子View
         */
        getChildAt(0).layout(getMeasuredWidth() - getChildAt(0).getMeasuredWidth(), getMeasuredHeight() - mBottom - mChildAt.getMeasuredHeight(),
                getMeasuredWidth(), getMeasuredHeight() - mBottom);
       /* } else {
