...
import com.isport.brandapp.banner.BannerEntry;
import com.isport.brandapp.banner.page.CenterBigTransformer;
import com.isport.brandapp.banner.page.Pageable;

import java.lang.reflect.Field;
import java.util.List;

import static com.isport.brandapp.banner.view.BannerView.MULTI_MODE_FROM_COVER_TO_COVER;
import static com.isport.brandapp.banner.view.BannerView.MULTI_MODE_FROM_COVER_TO_COVER_LOOP;
import static com.isport.brandapp.banner.view.BannerView.MULTI_MODE_INFINITE_LOOP;
import static com.isport.brandapp.banner.view.BannerView.SINGLE_MODE_CAN_NOT_PAGING;
import static com.isport.brandapp.banner.view.BannerView.SINGLE_MODE_NO_INDICATOR;
...
final class BannerHelper implements View.OnTouchListener, ViewPager.OnPageChangeListener {
    ...
    void setShowLeftAndRightPage(int showWidthDp, boolean reverseDrawingOrder, ViewPager.PageTransformer pageTransformer) {
        ...
        viewPager.setPageTransformer(reverseDrawingOrder, pageTransformer == null ? new CenterBigTransformer(1) : pageTransformer);
    }
