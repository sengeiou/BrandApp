...
public class PractiseItemW520Adapter extends RecyclerView.Adapter<PractiseItemW520Adapter.MyViewHolder> {

    private List<ExerciseInfo> mDatas;
    private Context mContext;
    private boolean isDetail;

    public PractiseItemW520Adapter(Context context, List<ExerciseInfo> data, boolean isDetail) {
        this.mDatas = data;
        mContext = context;
    ...
    public PractiseItemW520Adapter(Context context, List<ExerciseInfo> data) {
        this.mDatas = data;
        mContext = context;
        this.isDetail = false;
        if (data == null) {
    ...
    @Override
    public PractiseItemW520Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PractiseItemW520Adapter.MyViewHolder holder, int position) {
//        holder.iv_run.setImageResource();
        ...
        switch (Integer.valueOf(info.getExerciseType())) {
            ...
            case Constant.PRACTISE_TYPE_out:
                holder.tv_run.setText(mContext.getString(R.string.outdoor_running1));
            ...
            case Constant.PRACTISE_TYPE_in:
                ...
                holder.iv_type.setImageResource(R.drawable.icon_indorr);
                showSet(holder, 0);
                break;
