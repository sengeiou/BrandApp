...
import com.isport.brandapp.wu.adapter.PractiseItemW520Adapter
 ...
 *  on 2020/6/30
 */
class PractiseW520Adapter(data: MutableList<PractiseRecordInfo>) :
    ...
    lateinit var historyDayDetailAdapter: PractiseItemW520Adapter

    private fun setItemRecyclerView(recyclerView: RecyclerView, mExerciseInfos: MutableList<ExerciseInfo>) {
        recyclerView.layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        historyDayDetailAdapter = PractiseItemW520Adapter(context, mExerciseInfos)
